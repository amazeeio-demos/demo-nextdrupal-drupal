...
docker run --rm --net demo-nextdrupal-drupal_default amazeeio/dockerize dockerize -wait tcp://mariadb:3306 -timeout 1m
```
...
docker-compose exec -T cli bash -c "env" | grep LAGOON_ROUTE | grep demo-nextdrupal-drupal.docker.amazee.io
